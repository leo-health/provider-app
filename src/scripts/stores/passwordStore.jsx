...
module.exports = Reflux.createStore({
  ...
  onResetPasswordRequest: function(resetParam) {
    request.post('http://leo-api.elasticbeanstalk.com/api/v1/passwords/send_reset_email')
  ...
  onChangePasswordRequest: function(changeParam){
    request.put("http://leo-api.elasticbeanstalk.com/api/v1/passwords/" + changeParam.token + "/reset")
