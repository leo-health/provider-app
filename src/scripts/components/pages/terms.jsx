  ...
  render: function(){
    return(
        <div>
            ...
            <p>Leo Health provides a platform that allows you to manage your healthcare, including but not limited to scheduling medical appointments, communicating with healthcare providers, maintaining your medical records, and accessing educational articles concerning your health. The Website and Leo Health Services are not intended to, and should not be relied upon to provide financial, health, or legal advice.  Leo Health will retrieve Member information maintained by your healthcare provider's electronic health record ("Provider EHR").</p>

            <h3>Payment</h3>
            <p>You are responsible for all fees, including taxes, associated with your use of the Leo Health Services. By agreeing to these Terms of Service, you are giving us permission to charge your on-file credit card, PayPal account, or other approved methods of payment for fees that you authorize. Depending on the transaction, Leo Health may charge you on a one-time or recurring basis.</p>
            <p>You agree to provide us with complete and accurate billing and contact information. This information shall include your legal name, street address, e-mail address, and name and telephone number of an authorized billing contact. You agree to update this information within thirty days of any changes.</p>
            <p>Upon request, Leo Health will provide you with an invoice of the Leo Health Services that Leo Health has provided to you.  Except as otherwise provided in these Terms of Service, all fees are non-refundable.  Leo Health reserves the right to change the fees for Leo Health Services at any time without notice. If an action is commenced to enforce payment, you agree to pay Leo Health’s attorneys’ fees, court costs, and other costs of collection.</p>

            <h3>Third Party Services</h3>
            <p>By using the Leo Health Services and Website, you may receive services (“Third Party Services”) from contracted third parties (“Third Parties”) of Leo Health, or have the opportunity to visit the websites or resources offered by Third Parties,  which may be complementary to your use of the Leo Health Services.  Leo Health does not endorse, warrant or guarantee the products, materials or services provided by these Third Parties and Leo Health is not an agent or broker or otherwise responsible for the activities or policies of such Third Parties.  These Third Parties may require you to  agree to their own privacy policies and terms of service with respect to their provision of the Third Party Services to you. You are solely responsible for, and assume all risk arising out of your receipt of any Third Party Service.  Leo Health is not responsible for the availability of the Third Party Services or the information and security or privacy practices of these Third Parties.</p>
            <p>By your use of the Leo Health Services, you authorize Leo Health to submit to appropriate Third Parties any and all documents and information about you that are maintained by Leo Health necessary for such Third Party to provide the Third Party Service to you (collectively, the “Shared Information”). You are solely responsible for the accuracy of all Shared Information you provide to Leo Health.</p>

            <h3>Rights You Grant to Leo Health</h3>
            <p>By submitting information, data, passwords, usernames, PINs, other log-in information, materials and other content ("Content") to Leo Health through the Service, you are granting a license to Leo Health to use the Content for the purpose of providing the Leo Health Services.  Leo Health may use, disclose and store the Content, but only as described in the <a href="/#/privacy">Leo Health Privacy Policy</a>.  By submitting any Content to Leo Health, you represent that you are entitled to submit it to Leo Health, without any obligation by Leo Health to pay any fees or other limitations. By using the Leo Health Services, you expressly authorize Leo Health to access your personally identifiable information maintained by your healthcare providers.</p>
            ...
            <h3>Privacy</h3>
            <p>Your use of the Website and/or Leo Health Services is also subject to <a href="/#/privacy">Leo Health's Privacy Policy</a>, which is incorporated herein by reference in its entirety.</p>
            ...
            <p>These Terms of Service, along with the <a href="/#/privacy">Leo Health Privacy Policy</a>, constitute the entire and exclusive understanding and Terms of Service between Leo Health and you regarding the Website, Leo Health Services and Content, and supersede and replace any and all prior oral or written understandings or terms of service between Leo Health and you regarding the Website and the Leo Health Services.</p>
