      ...
      <div className="row">
        <div className="col-lg-offset-4 col-lg-4 col-lg-offset-4 jumbotron">
            <div className="text-center">
              ...
              <p>
                Once we've heard from them, you'll receive an email from Apple's TestFlight service with instructions on how to download the app, and then you can take advantage of all of Leo's services.
              </p>
              <br/>
